...
The x86 architecture contains special \textit{Trap flag}. When it is set, the processor issues interrupt \texttt{INT1} every time an instruction is executed. \todo{Doplnit nebo smazat: Viz konzultace}.
...
\todo{https://learn.microsoft.com/en-us/windows/win32/debug/debugging-events}
