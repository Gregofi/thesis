...
\subsection{Interrupts}\label{section:interrupt}
...
For a step in, we can use the \texttt{PTRACE\_SINGLESTEP} command. We
...
\texttt{readelf}~\cite{readelf} tools to construct these examples\todo{Should I
cite all of these guys?}. The information DWARF encodes is stored in various
