...
\ref{section:source-level-debugging}. For now, it is important to understand
that the computer cannot run the source code of a high-level language directly,
and that it is translated into machine code. Additionally, compilers often take
...
compiler, like register allocation or optimization, instead of the uninteresting
