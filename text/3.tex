...
all C operators, including the assignment operator. It, however, has a stricter
...
various variables or expressions. If an user wishes to modify part of an array,
there is no need to use the raw memory or register setters. Instead, it is
possible to just write \texttt{array[x] = y}.
