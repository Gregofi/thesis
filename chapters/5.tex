...
production ready and \todo{Trosku odvazny ale snad to tak dopadne} already used
in the NI-GEN course at FIT CTU. This debugger is extensible enough that if a
new architecture, virtual machine, or source language comes into play, it
should be fairly easy to add debugging support.
