...
This is what interpreting means. Dynamically typed languages tend to be interpreted \cite{python, lua, javascript}\todo{Instead of languages, cite some relevant source}. Since the interpreter is a program, it is another layer of abstraction. This can make
the resulting languages sometimes more abstract then the compiled ones, sometimes at the cost of performance.\todo{Ocitovat tohle vsechno}.
