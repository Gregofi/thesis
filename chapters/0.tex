...
incomprehensible. \todo{Maybe refer to a figure}.
...
about them in detail in chapter \todo{Debugging - Compiler support}. For now,
...
architecture to make the program faster \todo{figure s opt. programem}.
