...
square/.style = {draw=blue!60, fill=blue!5, very thick, 
                 minimum height=1cm, minimum width=3em,
                 outer sep=0pt,
        ...
        \node (pro3) [square,
                      right=of pro2] {Base pointer backup}; 
        \node (pro4) [square, right=of pro3] {Potential backup of other registers}; 
        \node (pro5) [square, right=of pro4] {Allocated space for variables}; 
    \end{tikzpicture}
\end{figure}
