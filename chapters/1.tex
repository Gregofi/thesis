...
it is specified how they should be encoded into binary. CPU then \textit{implements} some ISA. If two
...
\begin{itemize}
    \item \mintinline{c}{EXCEPTION_BREAKPOINT} - Raised when a hardware-defined
        breakpoint was encountered. This includes the mentioned
        \mintinline{c}{INT3} instruction.
    \item \mintinline{c}{EXCEPTION_SINGLE_STEP} - Raised when a hardware supported
...
\end{minted}
\caption{Windows debugger main loop, abbreviated. \todo{citace}}
