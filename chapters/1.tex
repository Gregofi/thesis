...
(called prologue and epilogue). DWARF encodes information about registers
throughout all lines of the code, so that we may reconstruct the necessary
information.

This table would again be very big, so DWARF once again resorts to virtual machine.
