...
\begin{figure}
    \centering
    \includegraphics[width=5cm,scale=0.5]{media/bp}
...
counter ends up\footnote{And there can be a \textit{lot} of
instructions~\cite{intel-manual}}. However, some architectures offer hardware
support, like the trap flag we mentioned in section \todo{ref}.
